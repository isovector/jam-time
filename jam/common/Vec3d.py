# from http://www.pygame.org/wiki/3DVectorClass
...
class Vec3d(object):
    ...
    def clamp(self, bounds):
        self.x = clamp(self.x, bounds[0], bounds[1])
        self.y = clamp(self.y, bounds[2], bounds[3])
        self.z = clamp(self.z, bounds[4], bounds[5])
